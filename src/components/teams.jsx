...
export default function Team() {
  ...
  return (
    <div className="w-full projects pt-6">
      <div className="flex justify-between items-center mb-10 mt-10 mobile-l:mt-5 mobile-l:mb-5">
        <div>
          <h2 className=" capitalize text-gray-600 text-2xl mobile-l:text-xl font-semibold">
            Team Members
          </h2>
          <p className="text-gray-500 mobile-l:text-sm mobile-l:mt-1 mt-3">A total of 543 projects.</p>
        </div>
        <div className="flex">
          <button className="flex items-center leading-snug bg-bg-main text-white py-1 font-semibold px-4 mobile-l:px-2 rounded-[4px] text-center">
            <FontAwesomeIcon icon={faPlus} className="text-lg" />
            <span className="ml-2 leading-loose capitalize mobile-l:text-sm	">
              Create Member
            </span>
          </button>
        </div>
          ...
          <table className="w-full">
            <thead className=" border-b">
              <tr className="w-full">
                ...
                <th className="client-th  min-w-[11rem]">Member</th>
                <th className="client-th min-w-[11rem]">Role</th>
                <th className="client-th min-w-[12rem]">Balance</th>
                <th className="client-th min-w-[9rem] ">P.Tasks</th>
                <th className="client-th min-w-[10rem]">Created On</th>
              ...
              <tr>
                ...
                <td className="clients-td text-slate-400">
                  <div
                    ...
                    className="status pl-8 text-yellow-500 before:bg-yellow-500 bg-yellow-200"
                  >
                    Staff
                  </div>
                </td>
                ...
                <td className="pl-6 clients-td text-slate-400">2/2 </td>
